 ...
 * @Bean("UserTradeAmountLogLoan")
 */
class UserTradeAmountLogLoan{
    ...
    private $table_prefix = 'user_amount_log_loan_';
...
//        $end_timestamp = strtotime($end_time);
     ...
     * @throws \Swoft\Db\Exception\DbException
     */
    private function get_log(string $table_name, array $where, array $where_in, int $offset, int $limit)
    {
